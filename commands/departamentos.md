---
description: Lista os 8 departamentos do HAOS com descrição, entry-point e quantos agentes
---
# /haos:departamentos — Lista de Departamentos (8)
...
| `/haos:orquestracao` | qa-reviewer | 5 | QA, PM, compliance, devops, due diligence |
| `/haos:seguranca` | chuck-norris | 2 | Security, concierge externo |

Termine com: `Use /haos:agentes pra ver a lista completa dos 30 agentes individuais.`